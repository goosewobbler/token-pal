const BlastIcon = () => (
  <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 215 215' fill='none'>
    <title>Blast</title>
    <path
      ...
      fill='currentColor'
    />
    <path d='M59.3 145.4L77.6 88.4002L57.3 73.2002L26.8 168.9H140.4L148 145.4H59.3Z' fill='currentColor' />
  </svg>
);
